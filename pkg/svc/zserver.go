...
//
// TODO: Extend the Catalog service by defining new RPCs and
...
//
// TODO: Create an implementation of the Catalog server
...
// implementation of Catalog server interface service, but only
...
// Default implementation of the Catalog server interface
...
func NewBasicServer(database *gorm.DB) (pb.CatalogServer, error) {
